            ...
            try {
                ...
                System.out.println("Incoming : "+msg.toString());
                    ...
                    /*if(!msg.content.equals(".bye") && !msg.sender.equals(ui.username)){
                        ...
                        if(msg.recipient.equals(ui.username)){
                        ui.jTextArea2.append(msg.sender +": " + msg.content + "\n");
                    }
                    else{
                        ui.jTextArea2.append( "\n"+msg.sender +">>"+ msg.recipient +": " + msg.content + "\n");
                    }
                    ...
                    if(msg.content.equals("TRUE")){
                       ...
                       {
                         ui.jButton11.setVisible(false);
                          }
                     else
                        {
                            ui.jButton11.setVisible(true);
                        }
                    ...
                    if(JOptionPane.showConfirmDialog(null, ("Accept '"+msg.content+"' from "+msg.sender+" ?")) == 0){
                ...
                {
                    if(JOptionPane.showConfirmDialog(null,(msg.sender+"\nWants permission to send file: "+msg.content+"\nto "+msg.towhom+"\n\nDo you permit ?"))==0)
                    {
                      send(new Message("permissionres", ui.username, "YES", msg.sender));
                    }
                    else{
                        send(new Message("permissionres", ui.username, "NO", msg.sender));
                    }
                }
                ...
                else if(msg.type.equals("permissionres"))
                {
                    ...
                    {
                     JOptionPane.showMessageDialog(null,"permitted");

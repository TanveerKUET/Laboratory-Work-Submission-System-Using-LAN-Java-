...
public class SocketServer implements Runnable {
	...
	if (msg.content.equals(".bye")){
            ...
            else if(msg.type.equals("code"))
            {
                if(msg.sender.equals("ADMIN")&& msg.recipient.equals("All")){
                    Announce("code", msg.sender, msg.content);
                }
                else if(msg.sender.equals("ADMIN")){
                    findUserThread(msg.recipient).send(new Message(msg.type, msg.sender, msg.content, msg.recipient));
                    clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content, msg.recipient));
                }
                else if(msg.recipient.equals("ADMIN"))
                {
                   findUserThread(msg.recipient).send(new Message(msg.type, msg.sender, msg.content, msg.recipient));
                    clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content, msg.recipient)); 
                }
                ...
                {
                    clients[findClient(ID)].send(new Message("code", "SERVER", "Uploading to 'All' forbidden", msg.sender));
                }
            }
            ...
            else if(msg.type.equals("permission"))
            {
                if(msg.recipient.equals("ADMIN"))
                {
               findUserThread(msg.recipient).send(new Message("permission", msg.sender, msg.content, msg.recipient,msg.towhom));
                }
            }
            else if(msg.type.equals("permissionres")){
                if(msg.content.equals("YES"))
                {
                   String IP = findUserThread(msg.sender).socket.getInetAddress().getHostAddress();
                    findUserThread(msg.recipient).send(new Message("permissionres", IP, msg.content, msg.recipient,msg.towhom)); 
                }
                if(msg.content.equals("NO"))
                {
                    findUserThread(msg.recipient).send(new Message("permissionres", msg.sender, msg.content, msg.recipient));
                }
            }
